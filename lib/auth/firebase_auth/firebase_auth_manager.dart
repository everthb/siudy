    ...
    try {
      ...
      if (e.code == 'requires-recent-login') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Ha pasado demasiado tiempo desde el inicio de sesión mas reciente. Inicie sesión cuanto antes para no eliminar su cuenta.')),
        );
      }
    }
  }
    ...
    try {
      ...
      if (e.code == 'requires-recent-login') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Ha pasado demasiado tiempo desde el inicio de sesión mas reciente. Inicie sesión cuanto antes para no eliminar su Email.')),
        );
      }
    }
  }
