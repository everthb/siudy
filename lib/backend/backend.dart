...
import 'schema/venta_datos_record.dart';
import 'schema/ubicacion_cliente_record.dart';
...
export 'schema/venta_datos_record.dart';
export 'schema/ubicacion_cliente_record.dart';
...
/// Functions to query VentaDatosRecords (as a Stream and as a Future).
Future<int> queryVentaDatosRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VentaDatosRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VentaDatosRecord>> queryVentaDatosRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VentaDatosRecord.collection,
      VentaDatosRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VentaDatosRecord>> queryVentaDatosRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query UbicacionClienteRecords (as a Stream and as a Future).
Future<int> queryUbicacionClienteRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UbicacionClienteRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UbicacionClienteRecord>> queryUbicacionClienteRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      UbicacionClienteRecord.collection,
      UbicacionClienteRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UbicacionClienteRecord>> queryUbicacionClienteRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
